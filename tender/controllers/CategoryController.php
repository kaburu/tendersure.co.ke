...
class CategoryController extends Controller {
     ...
     * @return mixed
     */
    public function actionSelectbid($id) {
        
        if ((\app\models\Bidder::findOne(Yii::$app->user->getId())) == null) {
            throw new \yii\web\UnauthorizedHttpException('You must create a bidder account to continue');
        }
